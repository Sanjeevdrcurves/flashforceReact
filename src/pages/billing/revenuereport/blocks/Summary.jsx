   ...
   <div className="card rounded-xl">
        <div className="flex items-center justify-between grow gap-5 p-5 rtl:bg-[center_left_-8rem] bg-[center_right_-8rem] bg-no-repeat bg-[length:700px] upgrade-bg">
          <div className="flex items-center gap-4">
            <CommonHexagonBadge stroke="stroke-primary-clarity" fill="fill-primary-light" size="size-[50px]" badge={<KeenIcon icon="dollar" className="text-1.5xl text-primary" />} />
...
<div className="flex flex-col gap-2">
  ...
  <div className="grid grid-cols-1 gap-1.5  rounded-md px-2.5 py-2 shrink-0 min-w-24 max-w-auto">
     <div className="card rounded-xl">
        <div className="flex items-center justify-between grow gap-5 p-5 rtl:bg-[center_left_-8rem] bg-[center_right_-8rem] bg-no-repeat bg-[length:700px] upgrade-bg">
          <div className="flex items-center gap-4">
            <CommonHexagonBadge stroke="stroke-primary-clarity" fill="fill-primary-light" size="size-[50px]" badge={<KeenIcon icon="people" className="text-1.5xl text-primary" />} />
