...
// These have full IANA time zone values (e.g., "America/Los_Angeles")
export const tzStrings = [
    ...
    { label: "(GMT+00:00) Greenwich Mean Time : Dublin,Lisbon,London", value: "Etc/Greenwich" },
  ...
  // These have only numeric or decimal offsets (e.g., "-8", "5.5")
  export const tzInts = [
