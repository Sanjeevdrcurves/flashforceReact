...
import { NewTwilioUserTabel } from './blocks/NewTwilioUserTabel';
import { RightDrawer } from './blocks/RightDrawer';

const AddnewTwilioUser = () => {
  return (
    <Fragment>     
      <PageNavbar />  
       <div className="container-fixed" id='createnewplan'>
        ...
        <Toolbar>
            <ToolbarHeading>
               <h1 className="text-xl font-medium leading-none text-gray-900">Twillio Account</h1>
...
export default AddnewTwilioUser
