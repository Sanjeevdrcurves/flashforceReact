...
const EditNotes = () => {
  ...
  const { noteId, name, objecttypeid, objectid } = useParams() || { personId: 1001 };
  ...
  useEffect(() => {
    const fetchActivity = async () => {
      try {
        const url = `${API_URL}/CustomObject/GetNotes?noteId=${noteId}&companyId=${companyId}&customObjectTypeId=0`;
    ...
    fetchActivity();
  }, [noteId, companyId, name, objecttypeid, objectid]);
  ...
  const handleFormSubmit = async (values) => {
    ...
    try {
      ...
      const updatedRecord = {
        NoteId: serverActivityRecord.NoteId,
        ...updatedCoreProps,
      ...
      const payload = {
        ...
        noteId: serverActivityRecord.NoteId,
        noteData: JSON.stringify(updatedRecord),
      };
