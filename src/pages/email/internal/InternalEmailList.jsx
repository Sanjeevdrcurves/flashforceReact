  ...
  const fetchEmails = async () => {
    ...
    try {
      const response = await axios.get(`${API_URL}/email/fetch-filtered`, {
        params: { pageNumber: page, pageSize, debouncedSearch, filter, userId, type:"INTERNAL" },
      });
        ...
        {loading ? (
            ...
            <table className="w-full border-collapse border border-gray-200 table-fixed" >
                ...
                <tr className="bg-gray-100">
                    ...
                    <th className="p-2 border border-gray-200 text-left" style={{ width: "50px" }}>Received Date</th>
                </tr>
                </thead>
                <tbody>
                {emails.map((email) => (
                    ...
                    <td className="p-2 border border-gray-200" style={{ width: "50px" }}>{email.senderName}</td>
                    <td className="p-2 border border-gray-200 w-30 truncate" style={{ width: "100px" }}>{email.subject}</td>
                    <td className="p-2 border border-gray-200 text-gray-500" style={{ width: "50px" }}>
...
export default InternalEmailList;
